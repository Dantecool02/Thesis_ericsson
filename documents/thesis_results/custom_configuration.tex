...
\title{Adaptive Hybrid RAG}
\subtitle{Optimizing the Efficiency-Accuracy Trade-off via Learned Query Routing}

% give the alternative title - i.e., if the thesis is in English, then give a Swedish title
\alttitle{Adaptiv hybrid-RAG}
\altsubtitle{Optimering av avvägningen mellan effektivitet och noggrannhet med inlärd frågeroutning}
...
\courseCode{DA233X} % Degree project course for Machine Learning, second cycle
\courseCredits{30.0} % typically: \courseCredits{15.0} or \courseCredits{30.0}

% Fill in your program code 
\programcode{TMAIM}         % Master's Programme, Machine Learning, 120 credits
...
% --- Author Information ---
\authorsLastname{Wesslund}
\authorsFirstname{Dante}
\email{dantew@kth.se}
\kthid{u1eah7gh}
...
\hostcompany{Ericsson} % Remove this line if the project was not done at a host company
...
\supervisorAsLastname{Eriksson}
\supervisorAsFirstname{Arvid}
\supervisorAsEmail{arveri@kth.se}
% If the supervisor is from within KTH add their KTHID, School and Department info
%\supervisorAsKTHID{TODO-KTHID}
\supervisorAsSchool{\schoolAcronym{EECS}}
\supervisorAsDepartment{} % TODO: add exact KTH department if required.
...
\supervisorBsLastname{Zhang}
\supervisorBsFirstname{Peng}
\supervisorBsEmail{} % TODO: add Peng Zhang's email if it should appear in DiVA metadata.
% If the supervisor is from within KTH add their KTHID, School and Department info
%\supervisorBsKTHID{}
%\supervisorBsSchool{}
%\supervisorBsDepartment{}
% other for a supervisor outside of KTH add their organization info
\supervisorBsOrganization{Ericsson}
...
\examinersLastname{Herman}
\examinersFirstname{Pawel}
\examinersEmail{paherman@kth.se}
% If the examiner is from within KTH add their KTHID, School and Department info
%\examinersKTHID{TODO-KTHID}
\examinersSchool{\schoolAcronym{EECS}}
\examinersDepartment{} % TODO: add exact KTH department if required.
...
%% 10210 = Artificial Intelligence, 10208 = Natural Language Processing
\nationalsubjectcategories{10210, 10208}
...
% --- Thesis code repository URL (referenced from the Reflections section) ---
% Set this to the public GitHub URL for the code. If the repository is not yet
% public, leave the placeholder or comment the \url{} call in the reflections.
\newcommand{\thesisCodeUrl}{https://github.com/<your-handle>/<repo-name>}
