...
\begin{itemize}
    ...
    \item Does a query-only learned router improve over a heuristic that routes by a coarse question-category label alone?
\end{itemize}
