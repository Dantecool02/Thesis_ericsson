...
\subtitle{Optimizing the Cost-Performance Trade-off via Learned Query Routing}

% give the alternative title - i.e., if the thesis is in English, then give a Swedish title
\alttitle{Adaptiv hybrid-RAG}
\altsubtitle{Optimering av kostnads-prestanda-avvägningen med inlärd frågeroutning}
...
% --- Thesis code repository URL (referenced from the Supporting materials appendix) ---
\newcommand{\thesisCodeUrl}{https://github.com/Dantecool02/Thesis_ericsson}
